...
class Racing (private val game: Game) {
        ...
        when (dialog.name) {
            ...
            "strategy" -> {
                ...
                val runningStyleString: String = when {
                    // If race strategy override is disabled, just use the AUTO strategy.
                    !enableRaceStrategyOverride -> "AUTO"
    ...
    fun checkEligibilityToStartExtraRacingProcess(): Boolean {
        ...
        if (enableFarmingFans && enableRacingPlan && game.currentDate.year != DateYear.JUNIOR) {
                ...
                val eligiblePlannedRaces = userPlannedRaces.filter { plannedRace ->
                    ...
                    if (raceDetails == null) {
                        ...
                        if (turnDistance < 0 || turnDistance > lookAheadDays) {
                            ...
                            if (game.currentDate.year == DateYear.CLASSIC) {
