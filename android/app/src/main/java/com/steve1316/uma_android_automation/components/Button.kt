...
object ButtonAutoSelect : ComponentInterface {
    ...
    override val templates: List<Template> = listOf(
        Template("components/button/auto_select")
    )
}
...
object ButtonBack : ComponentInterface {
    ...
    override val templates: List<Template> = listOf(
        Template("components/button/back")
    )
}
...
object ButtonBackGreen : ComponentInterface {
    ...
    override val templates: List<Template> = listOf(
        Template("components/button/back_green")
    )
}
...
object ButtonBorrowSupportCard : ComponentInterface {
    ...
    override val templates: List<Template> = listOf(
        Template("components/button/borrow_support_card")
    )
}
...
object ButtonBurger : ComponentInterface {
    ...
    override val templates: List<Template> = listOf(
        Template("components/button/burger")
    )
}
...
object ButtonCancel : ComponentInterface {
    ...
    override val templates: List<Template> = listOf(
        Template("components/button/cancel")
    )
}
...
object ButtonChangeRunningStyle : ComponentInterface {
    ...
    override val templates: List<Template> = listOf(
        Template("components/button/change")
    )
}
...
object ButtonClose : ComponentInterface {
    ...
    override val templates: List<Template> = listOf(
        Template("components/button/close")
    )
}
...
object ButtonCollectAll : ComponentInterface {
    ...
    override val templates: List<Template> = listOf(
        Template("components/button/collect_all")
    )
}
...
object ButtonConfirm : ComponentInterface {
    ...
    override val templates: List<Template> = listOf(
        Template("components/button/confirm")
    )
}
...
object ButtonConfirmExclamation : ComponentInterface {
    ...
    override val templates: List<Template> = listOf(
        Template("components/button/confirm_exclamation")
    )
}
...
object ButtonDailyRaces : ComponentInterface {
    ...
    override val templates: List<Template> = listOf(
        Template("components/button/daily_races")
    )
}
...
object ButtonDailyRacesDisabled : ComponentInterface {
    ...
    override val templates: List<Template> = listOf(
        Template("components/button/daily_races_disabled")
    )
}
...
object ButtonDailyRacesJupiterCup : ComponentInterface {
    ...
    override val templates: List<Template> = listOf(
        Template("components/button/daily_races_jupiter_cup_logo")
    )
}
...
object ButtonDailyRacesMoonlightSho : ComponentInterface {
    ...
    override val templates: List<Template> = listOf(
        Template("components/button/daily_races_moonlight_sho_logo")
    )
}
...
object ButtonEditTeam : ComponentInterface {
    ...
    override val templates: List<Template> = listOf(
        Template("components/button/edit_team")
    )
}
...
object ButtonFollow : ComponentInterface {
    ...
    override val templates: List<Template> = listOf(
        Template("components/button/follow")
    )
}
...
object ButtonFinish : ComponentInterface {
    ...
    override val templates: List<Template> = listOf(
        Template("components/button/finish")
    )
}
...
object ButtonGiveUp : ComponentInterface {
    ...
    override val templates: List<Template> = listOf(
        Template("components/button/give_up")
    )
}
...
object ButtonToHome : ComponentInterface {
    ...
    override val templates: List<Template> = listOf(
        Template("components/button/to_home")
    )
}
...
object ButtonHomeSpecialMissions : ComponentInterface {
    ...
    override val templates: List<Template> = listOf(
        Template("components/button/home_special_missions")
    )
}
...
object ButtonHomePresents : ComponentInterface {
    ...
    override val templates: List<Template> = listOf(
        Template("components/button/home_presents")
    )
}
...
object ButtonSpecialMissionsTabDaily : ComponentInterface {
    ...
    override val templates: List<Template> = listOf(
        Template("components/button/special_missions_tab_daily")
    )
}
...
object ButtonSpecialMissionsTabMain : ComponentInterface {
    ...
    override val templates: List<Template> = listOf(
        Template("components/button/special_missions_tab_main")
    )
}
...
object ButtonSpecialMissionsTabTitles : ComponentInterface {
    ...
    override val templates: List<Template> = listOf(
        Template("components/button/special_missions_tab_titles")
    )
}
...
object ButtonSpecialMissionsTabSpecial : ComponentInterface {
    ...
    override val templates: List<Template> = listOf(
        Template("components/button/special_missions_tab_special")
    )
}
...
object ButtonLegendRace : ComponentInterface {
    ...
    override val templates: List<Template> = listOf(
        Template("components/button/legend_race")
    )
}
...
object ButtonLegendRaceDisabled : ComponentInterface {
    ...
    override val templates: List<Template> = listOf(
        Template("components/button/legend_race_disabled")
    )
}
...
object ButtonRaceHardInactive : ComponentInterface {
    ...
    override val templates: List<Template> = listOf(
        Template("components/button/race_hard_inactive")
    )
}
...
object ButtonRaceHardActive : ComponentInterface {
    ...
    override val templates: List<Template> = listOf(
        Template("components/button/race_hard_active")
    )
}
...
object ButtonLegendRaceHomeSpecialMissions : ComponentInterface {
    ...
    override val templates: List<Template> = listOf(
        Template("components/button/legend_race_special_missions")
    )
}
...
object ButtonNext : ComponentInterface {
    ...
    override val templates: List<Template> = listOf(
        Template("components/button/next")
    )
}
...
object ButtonNextWithImage : ComponentInterface {
    ...
    override val templates: List<Template> = listOf(
        Template("components/button/next_with_image")
    )
}
...
object ButtonOptions : ComponentInterface {
    ...
    override val templates: List<Template> = listOf(
        Template("components/button/options")
    )
}
...
object ButtonLearn : ComponentInterface {
    ...
    override val templates: List<Template> = listOf(
        Template("components/button/learn")
    )
}
...
object ButtonReset : ComponentInterface {
    ...
    override val templates: List<Template> = listOf(
        Template("components/button/reset")
    )
}
...
object ButtonRace : ComponentInterface {
    ...
    override val templates: List<Template> = listOf(
        Template("components/button/race")
    )
}
...
object ButtonRaceAgain : ComponentInterface {
    ...
    override val templates: List<Template> = listOf(
        Template("components/button/race_again")
    )
}
...
object ButtonRaceDetails : ComponentInterface {
    ...
    override val templates: List<Template> = listOf(
        Template("components/button/race_details")
    )
}
...
object ButtonRaceEnd : ComponentInterface {
    ...
    override val templates: List<Template> = listOf(
        Template("components/button/race_end")
    )
}
...
object ButtonRaceEvents : ComponentInterface {
    ...
    override val templates: List<Template> = listOf(
        Template("components/button/race_events")
    )
}
...
object ButtonRaceExclamation : ComponentInterface {
    ...
    override val templates: List<Template> = listOf(
        Template("components/button/race_exclamation")
    )
}
...
object ButtonRaceExclamationShiftedUp : ComponentInterface {
    ...
    override val templates: List<Template> = listOf(
        Template("components/button/race_exclamation_shifted_up")
    )
}
...
object ButtonRaceManual : ComponentInterface {
    ...
    override val templates: List<Template> = listOf(
        Template("components/button/race_manual")
    )
}
...
object ButtonRaceRecommendationsCenterStage : ComponentInterface {
    ...
    override val templates: List<Template> = listOf(
        Template("components/button/race_recommendations_center_stage")
    )
}
...
object ButtonRaceRecommendationsPathToFame : ComponentInterface {
    ...
    override val templates: List<Template> = listOf(
        Template("components/button/race_recommendations_path_to_fame")
    )
}
...
object ButtonRaceRecommendationsForgeYourOwnPath : ComponentInterface {
    ...
    override val templates: List<Template> = listOf(
        Template("components/button/race_recommendations_forge_your_own_path")
    )
}
...
object ButtonRaceResults : ComponentInterface {
    ...
    override val templates: List<Template> = listOf(
        Template("components/button/race_results")
    )
}
...
object ButtonRestore : ComponentInterface {
    ...
    override val templates: List<Template> = listOf(
        Template("components/button/restore")
    )
}
...
object ButtonRetry : ComponentInterface {
    ...
    override val templates: List<Template> = listOf(
        Template("components/button/retry")
    )
}
...
object ButtonResume : ComponentInterface {
    ...
    override val templates: List<Template> = listOf(
        Template("components/button/resume")
    )
}
...
object ButtonSave : ComponentInterface {
    ...
    override val templates: List<Template> = listOf(
        Template("components/button/save")
    )
}
...
object ButtonSaveAndExit : ComponentInterface {
    ...
    override val templates: List<Template> = listOf(
        Template("components/button/save_and_exit")
    )
}
...
object ButtonSeeResults : ComponentInterface {
    ...
    override val templates: List<Template> = listOf(
        Template("components/button/see_results")
    )
}
...
object ButtonSelectLegacy : ComponentInterface {
    ...
    override val templates: List<Template> = listOf(
        Template("components/button/select_legacy")
    )
}
...
object ButtonShop : ComponentInterface {
    ...
    override val templates: List<Template> = listOf(
        Template("components/button/shop")
    )
}
...
object ButtonSkip : ComponentInterface {
    ...
    override val templates: List<Template> = listOf(
        Template("components/button/skip")
    )
}
...
object ButtonStartCareer : ComponentInterface {
    ...
    override val templates: List<Template> = listOf(
        Template("components/button/start_career")
    )
}
...
object ButtonStartCareerOffset : ComponentInterface {
    ...
    override val templates: List<Template> = listOf(
        Template("components/button/start_career_offset")
    )
}
...
object ButtonTeamRace : ComponentInterface {
    ...
    override val templates: List<Template> = listOf(
        Template("components/button/team_race")
    )
}
...
object ButtonTeamTrials : ComponentInterface {
    ...
    override val templates: List<Template> = listOf(
        Template("components/button/team_trials")
    )
}
...
object ButtonTitleScreen : ComponentInterface {
    ...
    override val templates: List<Template> = listOf(
        Template("components/button/title_screen")
    )
}
...
object ButtonTryAgain : ComponentInterface {
    ...
    override val templates: List<Template> = listOf(
        Template("components/button/try_again")
    )
}
...
object ButtonViewResults : ComponentInterface {
    ...
    override val templates: List<Template> = listOf(
        Template("components/button/view_results")
    )
}
...
object ButtonRaceStrategyFront : ComponentInterface {
    ...
    override val templates: List<Template> = listOf(
        Template("components/button/strategy_front_select")
    )
}
...
object ButtonRaceStrategyPace : ComponentInterface {
    ...
    override val templates: List<Template> = listOf(
        Template("components/button/strategy_pace_select")
    )
}
...
object ButtonRaceStrategyLate : ComponentInterface {
    ...
    override val templates: List<Template> = listOf(
        Template("components/button/strategy_late_select")
    )
}
...
object ButtonRaceStrategyEnd : ComponentInterface {
    ...
    override val templates: List<Template> = listOf(
        Template("components/button/strategy_end_select")
    )
}
...
object ButtonCareerQuick : ComponentInterface {
    ...
    override val templates: List<Template> = listOf(
        Template("components/button/career_quick")
    )
}
...
object ButtonCareerQuickEnabled : ComponentInterface {
    ...
    override val templates: List<Template> = listOf(
        Template("components/button/career_quick_enabled")
    )
}
...
object ButtonCareerSkipOff : ComponentInterface {
    ...
    override val templates: List<Template> = listOf(
        Template("components/button/career_skip_off")
    )
}
...
object ButtonCompleteCareer : ComponentInterface {
    ...
    override val templates: List<Template> = listOf(
        Template("components/button/complete_career")
    )
}
...
object ButtonCareerEndSkills : ComponentInterface {
    ...
    override val templates: List<Template> = listOf(
        Template("components/button/career_end_skills")
    )
}
...
object ButtonCraneGame : ComponentInterface {
    ...
    override val templates: List<Template> = listOf(
        Template("components/button/crane_game")
    )
}
...
object ButtonInheritance : ComponentInterface {
    ...
    override val templates: List<Template> = listOf(
        Template("components/button/inheritance")
    )
}
...
object ButtonRaceSelectExtra : ComponentInterface {
    ...
    override val templates: List<Template> = listOf(
        Template("components/button/race_select_extra")
    )
}
...
object ButtonRaceSelectExtraLocked : ComponentInterface {
    ...
    override val templates: List<Template> = listOf(
        Template("components/button/race_select_extra_locked")
    )
}
...
object ButtonRaceSelectExtraLockedUmaFinals : ComponentInterface {
    ...
    override val templates: List<Template> = listOf(
        Template("components/button/race_select_extra_locked_uma_finals")
    )
}
...
object ButtonRest : ComponentInterface {
    ...
    override val templates: List<Template> = listOf(
        Template("components/button/rest")
    )
}
...
object ButtonRestAndRecreation : ComponentInterface {
    ...
    override val templates: List<Template> = listOf(
        Template("components/button/rest_and_recreation")
    )
}
...
object ButtonInfirmary : ComponentInterface {
    ...
    override val templates: List<Template> = listOf(
        Template("components/button/infirmary")
    )
}
...
object ButtonRecreation : ComponentInterface {
    ...
    override val templates: List<Template> = listOf(
        Template("components/button/recreation")
    )
}
...
object ButtonViewResultsLocked : ComponentInterface {
    ...
    override val templates: List<Template> = listOf(
        Template("components/button/view_results_locked")
    )
}
...
object ButtonEndCareer : ComponentInterface {
    ...
    override val templates: List<Template> = listOf(
        Template("components/button/end_career")
    )
}
...
object ButtonRaceListFullStats : ComponentInterface {
    ...
    override val templates: List<Template> = listOf(
        Template("components/button/race_list_full_stats")
    )
}
...
object ButtonHomeFullStats : ComponentInterface {
    ...
    override val templates: List<Template> = listOf(
        Template("components/button/home_full_stats")
    )
}
...
object ButtonRecreationDate : ComponentInterface {
    ...
    override val templates: List<Template> = listOf(
        Template("components/button/recreation_date")
    )
}
...
object ButtonTrainingSpeed : ComponentInterface {
    ...
    override val templates: List<Template> = listOf(
        Template("components/button/training_speed")
    )
}
...
object ButtonTrainingStamina : ComponentInterface {
    ...
    override val templates: List<Template> = listOf(
        Template("components/button/training_stamina")
    )
}
...
object ButtonTrainingPower : ComponentInterface {
    ...
    override val templates: List<Template> = listOf(
        Template("components/button/training_power")
    )
}
...
object ButtonTrainingGuts : ComponentInterface {
    ...
    override val templates: List<Template> = listOf(
        Template("components/button/training_guts")
    )
}
...
object ButtonTrainingWit : ComponentInterface {
    ...
    override val templates: List<Template> = listOf(
        Template("components/button/training_wit")
    )
}
...
object ButtonTraining : ComponentInterface {
    ...
    override val templates: List<Template> = listOf(
        Template("components/button/training")
    )
}
...
object ButtonRaces : ComponentInterface {
    ...
    override val templates: List<Template> = listOf(
        Template("components/button/races")
    )
}
...
object ButtonHomeFansInfo : ComponentInterface {
    ...
    override val templates: List<Template> = listOf(
        Template("components/button/home_fans_info")
    )
}
