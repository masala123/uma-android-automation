...
const SkillPlanPreFinalsSettings = () => {
    ...
    const parsedSkillPlan: PlannedSkill[] = preFinalsSkillPlan && preFinalsSkillPlan !== "[]" && typeof preFinalsSkillPlan === "string" ? JSON.parse(preFinalsSkillPlan) : []
    ...
    const handleSkillPress = (skill: Skill) => {
        ...
        updateSkillsSetting("preFinalsSkillPlan", JSON.stringify(newPlan))
    }

    const clearAllSkillsFromPlan = () => {
        updateSkillsSetting("preFinalsSkillPlan", JSON.stringify([]))
    }
    ...
    const renderOptions = () => {
        return (
            <>
                <CustomCheckbox
                    id="enable-pre-finals-spend-all"
        ...
        <View style={styles.root}>
            <View style={styles.header}>
                <View style={styles.headerLeft}>
                    ...
                    <Text style={styles.title}>Pre-Finals Skill Plan</Text>
                </View>
            </View>
                ...
                <View className="m-1">
                    <View style={styles.section}>
                        <Text style={styles.description}>
                            {"Purchases skills automatically just before the finale season begins."}
                        </Text>

                        <Divider style={{ marginBottom: 16 }} />

                        <CustomCheckbox
                            id="enable-pre-finals-skill-plan"
                            checked={enablePreFinalsSkillPlan}
                            onCheckedChange={(checked) => updateSkillsSetting("enablePreFinalsSkillPlan", checked)}
                            label="Enable Pre-Finals Skill Plan (Beta)"
...
export default SkillPlanPreFinalsSettings
